<!-- Statistics Cards untuk Penelaah -->
<div class="row">
    <!-- Validasi Pending -->
...
<!-- Quick Actions untuk Penelaah -->
<div class="row">
    <div class="col-12">
        <div class="card card-outline card-primary">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-bolt"></i> Akses Cepat - Penelaah
                </h3>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="card bg-gradient-info">
                            <div class="card-body text-center">
                                ...
                                <h5>Laporan</h5>
                                <p class="mb-2 text-sm">Lihat Laporan</p>
                                <a href="javascript:;" data-page="laporan_sm" class="btn btn-sm btn-light">
                                    <i class="fas fa-arrow-right"></i> Buka
                                </a>
                            </div>
                        </div>
...
<div class="row">
    ...
    <div class="col-12 col-lg-4">
        ...
        <div class="card card-outline card-secondary">
            ...
            <div class="card-body p-0">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item">
                        <a href="javascript:;" data-page="validasi_sm" class="nav-link">
                            <i class="fas fa-check-circle text-danger"></i> Validasi Surat
                        </a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="card bg-gradient-info">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-lightbulb"></i> Tips Penelaah
                </h3>
            </div>
            <div class="card-body">
                <p class="mb-0">
                    <i class="fas fa-quote-left"></i> 
                    Sebagai penelaah, pastikan untuk memvalidasi surat dengan teliti sebelum diteruskan. 
                    Periksa kelengkapan dokumen dan data surat.
