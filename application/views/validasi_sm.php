...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Validasi Surat Masuk</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="" data-page="dashboard">Surat</a></li>
                        <li class="breadcrumb-item active">Validasi Surat Masuk</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body">
                            ...
                            if ($validasi) {
                                ...
                                <div class="callout callout-danger">
                                    ...
                                    Tidak ada validasi surat masuk. Terimakasih.
                                </div>
                                <?php
                            }
                            ?>
                                                    ...
                                                    <tr>
                                                        <td colspan="3">
                                                            <div align="right">
                                                                ...
                                                                <button onclick="SimpanPelaksanaan()"
